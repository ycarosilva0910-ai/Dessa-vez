...
class AudioManager:
    ...
    def sync_music(self, game):
        ...
        in_battle = game.state in ("playing", "paused", "run_upgrades", "upgrade", "curse_choice", "vinicius_mega") or (game.state == "settings" and getattr(game, "settings_return_state", "menu") == "paused")
        if in_battle:
            ...
            # Como o current_track nao muda entre playing/upgrade/curse_choice, a faixa nao reinicia.
