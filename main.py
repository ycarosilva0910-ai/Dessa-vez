...
class AudioManager:
    ...
    def sync_music(self, game):
        ...
        in_battle = game.state in ("playing", "paused", "run_upgrades", "vinicius_mega") or (game.state == "settings" and getattr(game, "settings_return_state", "menu") == "paused")
        if in_battle and getattr(game, "glonk_music_cut_timer", 0.0) > 0:
            self._stop_music_everywhere()
            return
        ...
        if in_battle:
            ...
            # Toda gameplay usa batalha.ogg. Bosses continuam usando a mesma musica-tema de batalha.
...
# ============================================================
CHARACTER_ORDER = ["Ana", "Kevyn", "Ycaro", "Kayk", "Pedro", "Ruan", "Pai do Kayk", "Strikada Egoísta", "Glonk 100% Power", "Vinicius 13", "Glonk"]
...
class CharacterRival(Boss):
    ...
    def update(self,dt,game):
        ...
        if self.rival_dash_time>0:
            self.rival_dash_time-=dt; self.pos += self.rival_dash_dir*self.speed*4.5*dt
...
class Game:
    ...
    def uses_aim_stick(self):
        return self.player.character in ("Kayk", "Ycaro", "Pedro")
    ...
    def update(self, dt):
        ...
        elif self.state in ("menu", "mode_select", "character_select", "difficulty_select", "curse_choice", "mode_complete", "shop", "upgrade", "death", "glonk_death", "upgrade_catalog", "bestiary", "forge", "items", "weapons", "control_editor", "run_upgrades", "whats_new", "achievements", "missions", "cheats", "vinicius_mega"):
    ...
    def submit_cheat(self):
        ...
        if self.cheat_money_mode:
            ...
            self.cheat_money_buffer = ""
            return
        if self.cheat_buffer == "9899":
            # Codigo-mestre secreto da V14 FINAL.
            SAVE["cheat_all_chars"] = True
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_ESCAPE:
                    if game.state == "menu":
                        ...
                        game.close_settings()
                    elif game.state in ("upgrade_catalog", "bestiary", "control_editor", "shop", "glonk_death", "death", "whats_new", "achievements", "missions", "cheats", "backup"):
